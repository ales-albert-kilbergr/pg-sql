...
import type { SqlErrorMatcher } from './sql-query.types';

export type ErrorMatcher<ERROR> = (
  error: any,
) => ERROR | undefined | false | null;

export function matchError<A>(fn1: ErrorMatcher<A>): SqlErrorMatcher<A>;
...
export function matchError<A, B, C>(
  ...
  fn2: ErrorMatcher<B>,
  fn3: ErrorMatcher<C>,
): SqlErrorMatcher<A | B | C>;
export function matchError<A, B, C, D>(
  fn1: ErrorMatcher<A>,
  fn2: ErrorMatcher<B>,
  fn3: ErrorMatcher<C>,
  fn4: ErrorMatcher<D>,
): SqlErrorMatcher<A | B | C | D>;
...
export function matchError<A, B, C, D, E, F, G, H>(
  ...
  fn7: ErrorMatcher<G>,
  fn8: ErrorMatcher<H>,
): SqlErrorMatcher<A | B | C | D | E | F | G | H>;
export function matchError<A, B, C, D, E, F, G, H, I>(
  ...
  fn8: ErrorMatcher<H>,
  fn9: ErrorMatcher<I>,
): SqlErrorMatcher<A | B | C | D | E | F | G | H | I>;
export function matchError<A, B, C, D, E, F, G, H, I, J>(
  ...
  fn9: ErrorMatcher<I>,
  fn10: ErrorMatcher<J>,
): SqlErrorMatcher<A | B | C | D | E | F | G | H | I | J>;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function matchError(...fns: ErrorMatcher<any>[]) {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  return (error: unknown): SqlErrorMatcher<any> => {
    for (const fn of fns) {
